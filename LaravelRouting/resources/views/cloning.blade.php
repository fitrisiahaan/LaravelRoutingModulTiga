          ...
          <div class="offcanvas-body pt-0 px-4">
            ...
            <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
              <li class="nav-item col-6 col-md-auto">
                ...
                <i class="bi-github"></i>
                <small class="ms-2d-md-none">Github</small>
              </li>
              <li class="nav-item col-6 col-md-auto">
                <a href="#" class="nav-link active"></a>
              ...
              <li class="nav-item">
                ...
                <div class="dropdown" data-bs-theme="light">
                  <button
                    ...
                    aria-expanded="false"
                  >
                    <span class="d-lg-none">Bootsrap</span> v5.3
                  </button>
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <button
                        ...
                        type="button"
                      >
                        <small>lates (5.3.x)<i class="bi-check"></i></small>
                      </button>
                    </li>
                    <li>
                      <button class="dropdown-item bg-purple" type="button">
                        <small> v5.2.3 </small>
                      </button>
                    </li>
                    <li>
                    ...
                    <li><h6 class="dropdown-deader"> Previous releases</h6></li>
              ...
              <li class="nav-item col-12 col-lg-auto">
                ...
                <hr class="d-lg-none d-lg-flex h-100 mx-lg-2 text-white-50"></div>
              </li>
                ...
                <div class="bg-light mt-5" id="main">
                    ...
                    <div class="container py-5 px-4">
                        <div class="row">
                            ...
                            <p class="fs-5-mt-3"> Quickly design and customize responsive mobile-first sites with Bootstrap, the world's most popular front-end open source toolkit, featuring Sass variables and mixins, responsive grid system, extensive prebuilt components, and powerful javascript pluguns.</p>
                            <div class="row">
                            ...
                            <div class="text-muted">
                                currently <stong> v5.3.0-alpha2.</stong>
                                <a href="#"> v4.6.x docs</a>. <a href="#">All release</a>
                            </div>
                        </div>
                    </div>
                </div>
